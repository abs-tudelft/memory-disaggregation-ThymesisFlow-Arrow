...
arrow::Status RunMain() {
  ...
  // Much like a RecordBatch, a Table stores tabular data. However, a 
  // Table does not guarantee contiguity, due to being made up of ChunkedArrays. 
  // This can be useful for logic, paralellizing work, for fitting chunks into 
  // cache, or exceeding the 2,147,483,647 row limit present in Array and, 
  // thus, RecordBatch.
