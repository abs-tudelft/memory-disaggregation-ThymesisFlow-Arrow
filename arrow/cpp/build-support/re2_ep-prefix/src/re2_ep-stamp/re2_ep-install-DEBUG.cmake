...
set(stdout_log "/mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-install-out.log")
set(stderr_log "/mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-install-*.log")
  endif()
  ...
  set(msg "re2_ep install command succeeded.  See also /mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-install-*.log")
  message(STATUS "${msg}")
endif()
