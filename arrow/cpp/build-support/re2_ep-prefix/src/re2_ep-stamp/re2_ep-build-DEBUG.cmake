...
set(stdout_log "/mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-build-out.log")
set(stderr_log "/mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-build-*.log")
  endif()
  ...
  set(msg "re2_ep build command succeeded.  See also /mnt/afstuderen/arrow/cpp/build-support/re2_ep-prefix/src/re2_ep-stamp/re2_ep-build-*.log")
  message(STATUS "${msg}")
endif()
