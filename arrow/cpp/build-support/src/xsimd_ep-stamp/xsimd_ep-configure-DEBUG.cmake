...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/afstuderen/arrow/cpp/build-support/src/xsimd_ep-stamp/xsimd_ep-configure-*.log")
  endif()
  ...
  set(msg "xsimd_ep configure command succeeded.  See also /mnt/afstuderen/arrow/cpp/build-support/src/xsimd_ep-stamp/xsimd_ep-configure-*.log")
  message(STATUS "${msg}")
endif()
