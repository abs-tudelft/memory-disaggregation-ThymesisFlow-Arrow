...
set(stdout_log "/mnt/afstuderen/arrow/cpp/build-support/src/xsimd_ep-stamp/xsimd_ep-build-out.log")
set(stderr_log "/mnt/afstuderen/arrow/cpp/build-support/src/xsimd_ep-stamp/xsimd_ep-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/afstuderen/arrow/cpp/build-support/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
  endif()
  ...
  set(msg "xsimd_ep build command succeeded.  See also /mnt/afstuderen/arrow/cpp/build-support/src/xsimd_ep-stamp/xsimd_ep-build-*.log")
  message(STATUS "${msg}")
endif()
