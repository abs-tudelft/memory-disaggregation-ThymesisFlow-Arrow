...
#define ARROW_VERSION_PATCH 255
#define ARROW_VERSION ((ARROW_VERSION_MAJOR * 1000) + ARROW_VERSION_MINOR) * 1000 + ARROW_VERSION_PATCH

#define ARROW_VERSION_STRING "10.0.255"

#define ARROW_SO_VERSION "1000"
#define ARROW_FULL_SO_VERSION "1000.255.0"

#define ARROW_CXX_COMPILER_ID "GNU"
#define ARROW_CXX_COMPILER_VERSION "9.4.0"
#define ARROW_CXX_COMPILER_FLAGS " -fdiagnostics-color=always -ggdb -O0"
