...
set(stdout_log "/mnt/afstuderen/arrow/cpp/build-support/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-out.log")
set(stderr_log "/mnt/afstuderen/arrow/cpp/build-support/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/afstuderen/arrow/cpp/build-support/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-*.log")
  endif()
  ...
  set(msg "thrift_ep install command succeeded.  See also /mnt/afstuderen/arrow/cpp/build-support/thrift_ep-prefix/src/thrift_ep-stamp/thrift_ep-install-*.log")
  message(STATUS "${msg}")
endif()
