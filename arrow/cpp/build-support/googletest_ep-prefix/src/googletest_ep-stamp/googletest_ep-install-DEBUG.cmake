...
set(stdout_log "/mnt/afstuderen/arrow/cpp/build-support/googletest_ep-prefix/src/googletest_ep-stamp/googletest_ep-install-out.log")
set(stderr_log "/mnt/afstuderen/arrow/cpp/build-support/googletest_ep-prefix/src/googletest_ep-stamp/googletest_ep-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /mnt/afstuderen/arrow/cpp/build-support/googletest_ep-prefix/src/googletest_ep-stamp/googletest_ep-install-*.log")
  endif()
  ...
  set(msg "googletest_ep install command succeeded.  See also /mnt/afstuderen/arrow/cpp/build-support/googletest_ep-prefix/src/googletest_ep-stamp/googletest_ep-install-*.log")
  message(STATUS "${msg}")
endif()
